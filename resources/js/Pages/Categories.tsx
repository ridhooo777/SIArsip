...
export default function Categories({ categories, errors }: CategoriesProps) {
              ...
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button
                    ...
                    className="p-2 text-blue-600 hover:bg-blue-55 rounded-lg transition-colors"
                  >
                    <Edit3 size={16} />
                  </button>
                  <button
                    onClick={() => setDeleteConfirm(category.id)}
                    className="p-2 text-red-600 hover:bg-red-55 rounded-lg transition-colors"
                  >
                    <Trash2 size={16} />
                  </button>
                </div>
...
Categories.layout = (page: React.ReactNode) => <Layout>{page}</Layout>;
