...
export default function Dashboard({ stats, recentDocuments, recentActivity }: DashboardProps) {
  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-6">
      {/* Welcome Banner */}
      <motion.div variants={item} className="bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-800 rounded-2xl p-6 md:p-8 text-white relative overflow-hidden shadow-xl shadow-blue-600/10">
        ...
        <div className="relative z-10">
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            <Link
              href="/documents/add"
              className="inline-flex items-center gap-2 bg-white text-blue-700 px-5 py-2.5 rounded-xl font-semibold hover:bg-blue-50 transition-colors text-sm shadow-lg shadow-white/20"
            >
              <Plus size={18} />
              Input Arsip Baru
            </Link>
          ...
          <div className="p-5">
            {recentDocuments.length === 0 ? (
              <div className="text-center py-8 text-gray-500">
                ...
                <Link href="/documents/add" className="text-blue-600 text-sm font-medium mt-2 inline-block">
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-500">
                        {doc.category?.name || 'Tanpa Kategori'} • {formatDate(doc.created_at)}
                      </p>
                    </div>
